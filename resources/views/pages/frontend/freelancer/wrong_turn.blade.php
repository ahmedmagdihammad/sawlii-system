...
<head>
	...
	<!-- Font Awesome CSS -->
	<link rel="stylesheet" href="{{asset('frontend/worng_js/font-awesome.min.css')}}">

	<!-- Bootstrap and default Style -->
	<link rel="stylesheet" href="{{asset('frontend/worng_js/bootstrap.min.css')}}" >
	<link rel="stylesheet" href="{{asset('frontend/worng_js/style.css')}}">

	<!-- Google Fonts -->
	<link class="gf-headline" href="{{asset('frontend/worng_js/css.css')}}" rel='stylesheet' type='text/css'>
			
	<!-- Animate CSS -->
	<link rel="stylesheet" href="{{asset('frontend/worng_js/animate.min.css')}}">
	...
	html{
		height:100%;
		background: #ffffff url(http://localhost:8000/frontend/img/photo-1449168013943-3a15804bb41c.jpg); no-repeat center bottom fixed;
	...
	<!-- jQuery -->
	<script src="{{asset('frontend/worng_js/jquery.min.js')}}"></script>

	<!-- Modernizr -->
	<script src="{{asset('frontend/worng_js/modernizr.min.js')}}"></script>
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="{{asset('frontend/img/12887404231553072498.PNG')}}">
			
			<h1 id="cspio-headline">Oops!!</h1>			    				    				
			<h1 id="cspio-headline">Something Went Wrong</h1>			    				
			
			<div id="cspio-description">You will be redirected to site in 5 seconds..</div>			    				
