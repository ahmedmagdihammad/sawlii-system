                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="sawlii-tabs-wrap post-tabs">
                                <form method="post" action="{{route('post_job.store',$lang)}}" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="title_en" id="jobTitle_1"  value="" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control jobSubCategory" name="subcategory" id="jobSubCategory_1" data-fid="1" data-lid="0"  >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control budget" type="text" name="budget" id="budget_1" maxlength="6" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="3" name="description_en" id="description_1" class="form-control ckeditor" value=""></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6" id="skills">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control skill_choose_skillList skillList" multiple="multiple" name="skills[]" id="skill_1"  >
                                                                <option value='1'>AngularJS Developers</option><option value='2'>Android Developers</option><option value='3'>Bookkeepers</option><option value='4'>C# Developers</option><option value='5'>Content Writers</option><option value='6'>Copywriters</option><option value='7'>Customer Service Representatives</option><option value='8'>Data Entry Specialists</option><option value='9'>Email Marketing Consultants</option><option value='10'>Excel Experts</option><option value='11'>Facebook Marketers</option><option value='12'>Graphic Designers</option><option value='13'>Objective-C Developers</option><option value='14'>JavaScript Developers</option><option value='15'>JQuery Developers</option><option value='16'>Mobile App Developers</option><option value='17'>SEO Experts</option><option value='18'>PHP Developers</option><option value='19'>Python Developers</option><option value='20'>Sales Consultants</option><option value='21'>UI Designers</option><option value='22'>Social Media Consultants</option><option value='23'>Swift Developers</option><option value='24'>Technical Writers</option><option value='25'>Wordpress Developers</option><option value='27'>Virtual Assistants</option><option value='28'>Web Designers</option><option value='29'>Writers</option><option value='30'>Writer</option><option value='31'>UX Designers</option><option value='36'>Java</option><option value='37'>Node Js</option><option value='40'>React Js</option><option value='44'>Selenium Web Driver</option><option value='45'>QA Automation</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group post_job">
                                                            ...
                                                            <input type="date" name="deadline" class="form-control datepicker bidding_deadline" value="" id="biddingDeadline_1" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control estimatedDuration" name="duration" id="estimatedDuration_1" >
                                                                <option >undefined</option><option >1 day or less</option><option >Less than 1 week</option><option >1 to 2 weeks</option><option >3 to 4 weeks</option><option >1 to 6 month</option><option >More than 6 month</option><option >Ongoing</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control jobType" name="public" id="jobType_1"  >
                                                                <option value="0" >Public</option> <option value="1" >Private</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="material-switch ">
                                                                <input id="featured_1" name="featured_1" value="y" class="sp_switch_featured " data-fid="1" type="checkbox"  />
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="material-switch ">
                                                                <input class="hideFrmSearch" id="hideFrmSearch_1" name="hide" value="0" type="checkbox"  />
                                                ...
                                                <div class="row featured_job_opt hide">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="sp-quantity">
                                                                ...
                                                                <div class="sp-input">
                                                                    <input type="text" name="featured" id="featuredDuration_1" data-fid='1' class="quntity-input" value="0" >
                                                                </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="cost" id="perDayAmount_1" value="0" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row ">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="post-serviceimg form-group">
                                                            ...
                                                            <ul class="file-names clearfix" id="attchments_1"></ul>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="theme-form">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="title_ar" id="jobTitle_2"  value="" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control budget" type="text" name="budget_2" id="budget_2" maxlength="6" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="3" name="description_ar" id="description_2" class="form-control ckeditor" value=""></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group post_job">
                                                            ...
                                                            <input type="text" name="biddingDeadline_2" class="form-control datepicker bidding_deadline" id="biddingDeadline_2" value=""  />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control jobType" name="jobType_2" id="jobType_2" readonly disabled >
                                                                <option value="pu" >Public</option> <option value="pr" >Private</option><option value="pu" >Public</option> <option value="pr" >Private</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="material-switch ">
                                                                <input id="featured_2" name="featured_2" value="y" class="sp_switch_featured" data-fid="2" type="checkbox" y />
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="material-switch ">
                                                                <input id="featured_2" name="featured_2" value="y" class="sp_switch_featured " data-fid="2" type="checkbox"  />
                                                ...
                                                <div class="row featured_job_opt hide">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="sp-quantity">
                                                                ...
                                                                <div class="sp-input">
                                                                    <input type="text" name="featuredDuration_2" id="featuredDuration_2" class="quntity-input" value="1" >
                                                                </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control perDayAmount" type="text" name="perDayAmount_2" id="perDayAmount_2" value="10" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row hide">
                                                ...
                                                <div class="text-right">
                                                    <div class="theme-button">
                                                        ...
                                                        <button type="submit" class="btn btn-system" name="saveJob" id="saveJob">Submit(Submit)</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <ul class="question_lsit checkboxes" >
                                                        <li>
                                                            <label class="signin-check" for='que_1'>1. Please send me detailed quote
                                                                <input type='checkbox' id='que_1' data_id='1'  name='questions[1]' value="1">
