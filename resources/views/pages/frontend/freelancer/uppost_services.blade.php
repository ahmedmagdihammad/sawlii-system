                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="sawlii-tabs-wrap post-tabs">
                                ...
                                @endif
                                <form method="post" action="{{route('post_services.update',[$lang, $service->id])}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="tab-content">
                                            ...
                                            <div class="theme-form">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <ul class="file-names clearfix" id="attchments_1">
                                                        <img src="{{asset($service->image)}}" alt="not photo" width="100" height="100">
                                                    </ul>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" name="title_en" id="serviceTitle_1" value="{{$service->title_en}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control category" name="category" id="category">
                                                                ...
                                                                <option value="{{$service->category}}" selected>{{$service->getcategory->name}}</option>
                                                                @else
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control subcategory" name="subcategory" id="subcategory" >
                                                                ...
                                                                @else
                                                                <option value='{{$service->subcategory}}'>{{$service->getsubcategory->name}}</option>
                                                                @endif
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="sp-quantity">
                                                                ...
                                                                <div class="sp-input">
                                                                    <input type="text" name="days" id="noDayDelivery_1" class="quntity-input" value="{{$service->days}}">
                                                                </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control servicesPrice" name="price" id="servicesPrice_1" value="{{$service->price}}" maxlength="6" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="3" class="form-control ckeditor" name="description_en" id="description_1">{{$service->description_en}}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="3" name="details_en" id="requiredDetails_1">{{$service->details_en}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="material-switch ">
                                                                <input id="someSwitchOptionPrimary_1" name="featured_1" type="checkbox" checked  value="y" class="make_featured" data-fid="1" />
                                                ...
                                                <div class="row days_div_1" style="">
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="sp-quantity">
                                                                ...
                                                                <div class="sp-input">
                                                                    <input type="text" name="featured" id="no_of_days_1" class="quntity-input"  value="{{$service->featured}}">
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" name="addon_title_en" id="serviceTitle_1" value="{{$serviceaddon->title_en}}" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="sp-quantity">
                                                                                ...
                                                                                <div class="sp-input">
                                                                                    <input type="text" name="addon_days" id="noDayDelivery_1" class="quntity-input" value="{{$serviceaddon->days}}">
                                                                                </div>
                                                                                <div class="sp-plus sp-plus-delivery " data-fid="1"> <a class="ddd" href="javascript:void(0)">+</a>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control servicesPrice" name="addon_price" id="servicesPrice_1" value="{{$serviceaddon->price}}" maxlength="6" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-12 col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea rows="3" class="form-control ckeditor" name="addon_description_en" id="description_1">{{$serviceaddon->description_en}}</textarea>
                                                                            <label id="description-error_1" class="help-block" for="description"></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="tab-pane postarabic " dir="rtl" lang="ar"  id="postArabic">
                                            <div class="theme-form">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" name="title_ar" id="serviceTitle_2" value="{{$service->title_ar}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control category" name="category_2" id="category_2" data-fid="2" data-lid="1" disabled>
                                                                ...
                                                                <option value="{{$service->category}}">{{$service->getcategory->name}}</option>
                                                                @else
                                                                <option value="">Select Category</option>
                                                                @endif
                                                            </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="sp-quantity"> 
                                                                ...
                                                                <div class="sp-input">
                                                                    <input type="text" name="noDayDelivery_2" id="noDayDelivery_2" class="quntity-input" value="{{$service->days}}" disabled>
                                                                </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control servicesPrice" name="servicesPrice_2" id="servicesPrice_2" value="{{$service->price}}" maxlength="6" disabled />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="3" class="form-control ckeditor" name="description_ar" id="description_2">{{$service->description_ar}}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="3" name="details_ar" id="requiredDetails_2">{{$service->details_ar}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="material-switch ">
                                                                <input id="someSwitchOptionPrimary_2" name="featured_2" type="checkbox" checked value="y" class="make_featured" data-fid="2" disabled />
                                                ...
                                                <div class="row days_div_2" style="">
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="form-group">
                                                            <label class="featured_yn">
                                                                No. of days for featured :
                                                            ...
                                                            <div class="sp-quantity">
                                                                ...
                                                                <div class="sp-input">
                                                                    <input type="text" name="no_of_days" id="no_of_days_2" class="quntity-input" value="{{$service->featured}}" disabled>
                                                                </div>
                                                    ...
                                                    <div class="col-md-8 col-sm-6">
                                                        <label>Payable Amount : </label>
                                                        <div class="featured_amount" id="featured_amount_text_2">{{$service->cost}}$</div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" name="addon_title_ar" id="serviceTitle_2" value="{{$serviceaddon->title_ar}}" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="sp-quantity"> 
                                                                                ...
                                                                                <div class="sp-input">
                                                                                    <input type="text" name="#" id="noDayDelivery_2" class="quntity-input" value="{{$serviceaddon->days}}" disabled>
                                                                                </div>
                                                                                <div class="sp-plus sp-plus-delivery hide" data-fid="2"> <a class="ddd" href="javascript:void(0)">+</a>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control servicesPrice" name="#" id="servicesPrice_2" value="{{$serviceaddon->price}}" maxlength="6" disabled />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-12 col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea rows="3" class="form-control ckeditor" name="addon_description_ar" id="description_2">{{$serviceaddon->description_ar}}</textarea>
                                                                            <label id="description-error_2" class="help-block" for="description"></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
