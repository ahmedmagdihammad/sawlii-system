                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="sign_up_form">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-sm-12 right">
                                                    <div class="form-group">
                                                        <input type="text" name="firstname" id="firstname" class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" value="{{ $errors->has('firstname') ? ' is-invalid' : '' }}" value="{{ old('firstname') }}" placeholder="First Name" required autofocus/>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-sm-12 left">
                                                    <div class="form-group">
                                                        <input type="text" name="lastname" id="lastname" class="form-control{{ $errors->has('lastname') ? ' is-invalid' : '' }}" value="{{ old('lastname') }}" placeholder="Last Name" required autofocus/>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="location" id="#" class="form-control {{ $errors->has('location') ? ' is-invalid' : '' }}" value="{{ old('location') }}" placeholder="Location" required autofocus/>
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="username" id="username" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" value="{{ old('username') }}" placeholder="Username" required autofocus/>
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="email" id="#" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="Email" required autofocus/>
                                                @if($errors->has('email'))
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        <div class="g-recaptcha{{ $errors->has('g-recaptcha') ? ' is-invalid' : '' }}" data-sitekey="6LfZlKoZAAAAAOimeBTKGWud24wtfREgrRmLUeTv"></div>
