                                    ...
                                    <div class="sign_up_form">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group hide">
                                                <input type="text" name="type" value="C" class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}" placeholder="Type" required autofocus>
                                                @if($errors->has('type'))
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Confirm Password" required autofocus/>
                                            </div>
