    ...
    <!-- Dashboard Navigation End -->
                    <!-- Page Content -->
                                                        ...
                                                        <div class="box box-primary theme-box ">
                                                            <div class="box-body">
                                                                ...
                                                                <div class="myskills-box">
                                                                    ...
                                                                    <ul class="skills-list clearfix">
                                                                        <li>Arabic - Basic  <a href="javascript:void(0);" data-id="1" data-item-type="lang" class="delete_data remove-skill"></a></li>
                                                                        <li>
                                                                ...
                                                                <div class="myskills-box">
                                                                    ...
                                                                    <ul class="skills-list clearfix">
                                                                        ...
                                                                        <li>
                                                                            <a href="javascript:void(0)" class="addRecord" title="Add subcategory" data-entity="categories">
                                                                            Add more categories
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                        ...
                        <div class="modal fade" id="myModal" role="dialog" tabindex="-1">
                            <div class="modal-dialog">
                                <!-- Modal content-->
                                <form method="post" name="videoFrm" id="videoFrm">
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group">
                                            <label>
                                            Paste the link to your YouTube video here
                                            </label>
                                            <div class="input-group">
                                            <input type="text" class="form-control videoUrl" name="videoUrl" id="videoUrl">
                                            <span class="input-group-btn">
                                                <button type="button" class="videoPlay btn btn-system">Update</button>
                                            </span>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <div class="theme-button">
                                                <input type="hidden" name="action" value="videoAdd">
                                                <button type="button" class="btn btn-system btnSaveVideo">Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                    <select data-placeholder="Language list" class="form-control" name="language_name" id="language_name"><option value="">--Select Language--</option></select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                    <select data-placeholder="Language list" class="form-control" name="language_type" id="language_type">
                                ...
                                <div class="modal-footer">
                                <div class="theme-button">
                                    <input type="hidden" name="action" value="langAdd">
                                    <button type="submit" class="btn btn-system" name="saveLang" id="saveLang">Save</button>
                                </div>
                                </div>
                            </div>
                            </form>
                        ...
                        <div class="modal-dialog">
                            <!-- Modal content-->
                            <form name="categoryFrm" id="categoryFrm" method="post">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">
                                    &times;
                        ...
                        <h4>Accounts & Consultants</h4>
                        <div class="row">
                                <div class="col-md-6">
                            <label class="signin-check">&nbsp;Accounting Solutions
                                <input type="checkbox" name="cat_name[]" value="13" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
        
                        </div> 
                        </div><div class="cat-subcat">
                        <h4>Graphics Designing</h4>
                        <div class="row">
                                <div class="col-md-6">
                            <label class="signin-check">&nbsp;Mobile Development
                                <input type="checkbox" name="cat_name[]" value="4" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Other - Software Development
                                <input type="checkbox" name="cat_name[]" value="5" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Web & Mobile Design
                                <input type="checkbox" name="cat_name[]" value="6" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Custom Designs
                                <input type="checkbox" name="cat_name[]" value="8" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Machine Learning
                                <input type="checkbox" name="cat_name[]" value="9" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Scripts & Utilities
                                <input type="checkbox" name="cat_name[]" value="10" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                            <label class="signin-check">&nbsp;Ecommerce Development
                                <input type="checkbox" name="cat_name[]" value="2" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                            <label class="signin-check">&nbsp;Game Development
                                <input type="checkbox" name="cat_name[]" value="1" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Website Development
                                <input type="checkbox" name="cat_name[]" value="12" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                            <label class="signin-check">&nbsp;Data Visualization
                                <input type="checkbox" name="cat_name[]" value="7" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Data Analysis
                                <input type="checkbox" name="cat_name[]" value="11" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                            <label class="signin-check">&nbsp;Software Testing
                                <input type="checkbox" name="cat_name[]" value="3" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Automation Testing
                                <input type="checkbox" name="cat_name[]" value="17" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Manual Testing
                                <input type="checkbox" name="cat_name[]" value="18" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                            <label class="signin-check">&nbsp;Digital Marketing
                                <input type="checkbox" name="cat_name[]" value="15" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Network Marketing
                                <input type="checkbox" name="cat_name[]" value="16" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                            <label class="signin-check">&nbsp;One Page Designing
                                <input type="checkbox" name="cat_name[]" value="20" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Material Designs
                                <input type="checkbox" name="cat_name[]" value="21" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;Bootstrap Designs
                                <input type="checkbox" name="cat_name[]" value="22" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="signin-check">&nbsp;PSD Templates
                                <input type="checkbox" name="cat_name[]" value="23" >
                                <span class="checkmark"></span>
                            </label>
                        </div>
            ...
            <div class="modal-footer">
               ...
               <div class="theme-button">
                  ...
                  <button type="submit" name="addCategory" class="btn btn-system" id="addCategory">Save</button>
               </div>
            </div>
         </div>
      </form>
